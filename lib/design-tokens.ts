/**
 * Design Tokens for Carevo UI/UX System
 * 
 * This file defines the design system tokens that can be consumed by:
 * - Tailwind CSS (via config)
 * - Raw CSS (via CSS variables)
 * - TypeScript components (via imports)
 * 
 * All tokens follow a hierarchical naming convention:
 * - Semantic tokens (primary, success, warning, danger)
 * - Scale-based tokens (50, 100, 200, etc.)
...
export const designTokens = {
  ...
  // Breakpoints (for reference, actual breakpoints defined in Tailwind config)
  breakpoints: {
    sm: '640px',
    md: '768px',
    lg: '1024px',
